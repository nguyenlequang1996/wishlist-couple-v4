...
async function main() {
  ...
  console.log(`Đã tạo người dùng ${user1.username} và ${user2.username}`)
  ...
  console.log(`Đã tạo ${wishlistItems1.length + wishlistItems2.length} wishlist item mẫu`)
